                                                    ...
                                                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            ...
                                                            <div class="d-flex align-items-center mb-2">
                                                                <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">{{@$info->company_name}}</a>
                                                            </div>
                                                            <!--end::Name-->
                                                            ...
                                                            <div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
                                                                ...
                                                                <!--end::Svg Icon-->{{@$info->investortype?$info->investortype->name:'--'}}</a>
                                                                ...
                                                                <!--end::Svg Icon-->{{@$info->investmentExit?$info->investmentExit->name:'--'}}</a>
                                                            </div>
                                                            <!--end::Info-->
                                                        </div>
                                                        <!--end::User-->
                                                            ...
                                                            <div class="d-flex flex-wrap">
                                                                ...
                                                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        <!--end::Svg Icon-->
                                                                        <div class="fs-2 fw-bolder">{{@$info->year_founded}}</div>
                                                                    </div>
                                                                    <!--end::Number-->
                                                                    <!--begin::Label-->
                                                                    <div class="fw-bold fs-6 text-gray-400">Year Founded</div>
                                                                    <!--end::Label-->
                                                                </div>
                                                                <!--end::Stat-->
                                                            </div>
