<!-- Modal -->
<div class="modal fade" id="edit-setting-password-{{ $passwordSetting->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <form id="leadForm" action="{{route('password-settings.update',$passwordSetting->uuid)}}" method="POST" enctype="multipart/form-data">
          @csrf
          @method('PATCH')
          <div class="modal-body">
            <div class="row">
                @input(['input_name' => 'salt','value' => $passwordSetting->salt])
