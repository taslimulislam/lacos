...
<div class="">
    <div class="col-md-12">
        <div class="flex">
            <button class="btn btn-primary btn-md" data-bs-toggle="modal" data-bs-target="#pharseImportModal">Import Language</button>
...
<div class="modal fade" id="pharseImportModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
            <form action="{{route('lang.import', $lang->slug)}}" id="import-phrase" method="POST" enctype="multipart/form-data">
                @csrf
