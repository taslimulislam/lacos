...
<div class="modal fade" id="addmenu" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form id="leadForm" action="{{route('permissionmenu.store')}}" method="POST" enctype="multipart/form-data">
          @csrf
                    ...
                    <div class="col-md-12 text-start">
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-9 col-md-12 col-xl-9">
                                <select name="parentmenu_id" class="search_test" >
                                        <option value=""  >None</option>
                                    @foreach ($menuName as $menuNameValue )
                                        <option value="{{ $menuNameValue->id }}">{{ $menuNameValue->menu_name }}</option>
                                    @endforeach
