                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="cust_border form-group mb-3 mx-0 pb-3 row">
                                ...
                                <div class="col-lg-10 pe-0">
                                    <input type="number" class="form-control" name="startup_views" placeholder="" value="" required>
                            ...
                            <div class="cust_border form-group mb-3 mx-0 pb-3 row">
                                ...
                                <div class="col-lg-10 pe-0">
                                    <input type="number" class="form-control" name="report_views" placeholder="" value="" required>
                        ...
                        <div class="col-lg-6">
                            <div class="cust_border form-group mb-3 mx-0 pb-3 row">
                                ...
                                <div class="col-lg-10 pe-0">
                                    <textarea name="description" class="form-control" id="" cols="30" rows="1" required></textarea>
                            ...
                            <div class="cust_border form-group mb-3 mx-0 pb-3 row">
                                ...
                                <div class="col-lg-10 pe-0">
                                    <input type="text" style="width: 100% !important" value="" name="feature" data-role="tagsinput" />
