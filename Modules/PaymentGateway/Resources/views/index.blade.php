...
<form method="GET" action="{{route('check-payment')}}" id="paymentForm">

    @csrf

    <input type="hidden" name="amount" value="100"/> <!-- Replace the value with your transaction amount -->
    ...
    <input type="hidden" name="logo" value="http://64.225.72.133/public//uploads/app-setting/202209221234gdm-mini-logo.png"/>
    ...
    <input type="hidden" name="email" value="tuhinsorker92@gmail.com"/> <!-- Replace the value with your customer email -->
    <input type="hidden" name="firstname" value="Md Tuhin"/>
    <!-- Replace the value with your customer firstname (optional) -->
    <input type="hidden" name="lastname" value="Sarker"/>
    ...
    <input type="hidden" name="failureurl" value="http://localhost/phpTest/paymentForm.php/13b9gxc1?status=failed">
