        ...
        <div class="toolbar py-5 py-lg-15" id="kt_toolbar">
          ...
          <div id="kt_toolbar_container" class="container d-flex flex-stack flex-wrap">
            ...
            <div class="page-title d-flex flex-column me-3">
              <!--begin::Title-->
              <h1 class="d-flex fs-2hx fw-bolder text-white">Events for you</h1>
              <!--end::Title-->
              <p class="fs-4 text-white">Attend events around the startup space in Africa.</p>
          ...
          <div class="content flex-row-fluid" id="kt_content">
            ...
            <div class="row g-6 g-xl-9">
              ...
              <div class="col-sm-6 col-xl-3">
                <a href="{{route('event.detail',$item->uuid)}}" class="card card-flush h-xl-100">
                  <!--begin::Body-->
                  <div class="card-body text-center pb-5">
                    <img src="{{$img}}" alt="" class="img-fluid card-rounded mb-5">
                    <!--begin::Info-->
                    <div class="d-flex align-items-end flex-stack mb-1">
                      <!--begin::Title-->
                      <div class="text-start">
                        <span class="cursor-pointer d-block fs-4 fw-bold mb-4 text-gray-800 text-hover-primary">{{$item->event_title}}</span>
                        <span class="text-gray-400 mt-1 fw-bold fs-6">{{ date('d-M-Y',strtotime($item->start_date)) }}</span>
                      </div>
                      <!--end::Title-->
                      <!--begin::Total-->
                      <span class="bg-light-primary border border-primary fs-6 fw-bold px-3 rounded-1 text-end text-primary">Free</span>
                      <!--end::Total-->
                    </div>
                    <!--end::Info-->
                  </div>
