													...
													<div class="card h-100">
														...
														<div class="card-title m-0">
														  <div class="d-flex align-items-center">
															...
															<div class="flex-grow-1 ms-3">
															  <!--begin::Heading-->
															  <div class="fs-1 fw-bolder mb-0"><a href="{{route('hub.detail',$item->uuid)}}"> {{$item->name}} </a></div>
															  <!--end::Heading-->
															  <div class="fs-6 fw-bold text-primary">{{$item->industry?$item->industry->name:'---'}}</div>
															</div>
														  </div>
														</div>
														<!--end::Card title-->
													  ...
													  <div class="card-body d-flex flex-column px-9 pt-6 pb-8">
														...
														<div class="d-flex align-items-center fw-bold">
														  <span class="badge bg-light-primary me-2 px-3 py-2 text-primary"> {{$item->address?$item->address:'---'}}</span>
														</div>
														<!--end::Indicator-->
														<!--begin::Stats-->
