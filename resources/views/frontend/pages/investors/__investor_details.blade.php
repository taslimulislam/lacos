            ...
            <div class="toolbar py-5 py-lg-15" id="kt_toolbar">
                ...
                <div id="kt_toolbar_container" class="container d-flex flex-stack flex-wrap">
                    ...
                    <div class="page-title d-flex flex-column me-3">
                        <!--begin::Title-->
                        <h1 class="d-flex text-white fw-bolder my-1 fs-3">{{ @$investor->company_name }}</h1>
                        <!--end::Title-->
                    </div>
                    <!--end::Page title-->
                </div>
                ...
                <div class="card mb-6">
                    ...
                    <div class="align-items-center d-flex flex-sm-nowrap flex-wrap mb-3">
                        ...
                        <div class="me-7 mb-4">
                            @php
                                if($investor->logo){
                                $dom = explode('//',$investor->logo);
                                if(count($dom)>1){
                                    $img = $investor->logo;
                                }else{
                                    $img =  url('/public/storage/'.@$investor->logo);
                                }
                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                <h3 href="#" class="text-gray-900 fs-1 fw-bolder me-1 mb-0">{{ @$investor->company_name }}</h3>
                                
                            </div>
                            <!--end::Name-->

                            <!--begin::Description-->
                            <div class="d-flex flex-wrap fw-semibold mb-4 fs-5 text-gray-400">{{$investor->industry?$investor->industry->name:'---'}}
                            </div>
                            <!--end::Description-->
                            </div>
                            <!--end::User-->
                            ...
                            <div class="d-flex my-4">
                                ...
                                <a href="#" class="btn btn-sm me-2 btn-success" id="kt_user_follow_button">
                                    ...
                                    <span class="indicator-label" id="followUp" data-follow-route="{{route('follo-up',$investor->user_id)}}">Following</span>
                                ...
                                <a href="javascript:void(0)" class="btn btn-sm btn-light me-2"  id="kt_user_follow_button" >
                                    ...
                                    <!--end::Svg Icon-->
                                    <!--begin::Indicator-->
                                    <span class="indicator-label" id="followUp" data-follow-route="{{route('follo-up',$investor->user_id)}}">Follow</span>
                                    <span class="indicator-progress">Please wait...
                                    <span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                                    <!--end::Indicator-->
                                </a>
                                ...
                                @if($favoriteStatus==0)
                                <a href="javascript:void(0)" id="addToFavorite" data-favorite-route="{{route('add-to-up',$investor->user_id)}}" class="btn btn-sm btn-primary me-3">Add to Favorite</a>
                                @else
                                <a href="javascript:void(0)" id="addToFavorite" data-favorite-route="{{route('add-to-up',$investor->user_id)}}" class="btn btn-sm btn-primary me-3">Your Favorite</a>
                                @endif
                            </div>
                            <!--end::Actions-->
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="fs-2 fw-bolder" data-kt-countup="true" data-kt-countup-value="{{@$investor->year_founded}}" data-kt-countup-prefix="">0</div>
                                        </div>
                                        <!--end::Number-->
                                        <!--begin::Label-->
                    ...
                    <div class="mb-17">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mb-8">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    <div class="fs-3 fw-bolder">{{$investor->year_founded}}</div>
                                    <!--begin::Label-->
                                    ...
                                    <!--begin::Stat-->
                                    <div class="bg-white border-gray-300 mb-3 me-3 px-4 py-3 rounded shadow-sm text-center">
                                    <div class="fs-3 fw-bolder">{{@$investor->investmentExit?$investor->investmentExit->name:'--'}}</div>
                                    <!--begin::Label-->
                                    <div class="fw-bold  text-gray-400">Investment Exist</div>
                                    <!--end::Label-->
                                    </div>
                                    <!--end::Stat-->
                                    <!--begin::Stat-->
                                    <div class="bg-white border-gray-300 mb-3 me-3 px-4 py-3 rounded shadow-sm text-center">
                                    <div class="fs-3 fw-bolder">{{@$investor->investmentStage?$investor->investmentStage->name:'--'}}</div>
                                    <!--begin::Label-->
                                    <div class="fw-bold  text-gray-400">Investment Segment</div>
                                    <!--end::Label-->
                                    </div>
                                    <!--end::Stat-->
                                    <!--begin::Stat-->
                                    <div class="bg-white border-gray-300 mb-3 me-3 px-4 py-3 rounded shadow-sm text-center">
                                    <div class="fs-3 fw-bolder">{{@$investor->investorType?$investor->investorType->name:'--'}}</div>
                                    <!--begin::Label-->
                                    <div class="fw-bold  text-gray-400">Industry Type</div>
                                    <!--end::Label-->
                                    </div>
                                    <!--end::Stat-->
                                    <!--begin::Stat-->
                                    <div class="bg-white border-gray-300 mb-3 me-3 px-4 py-3 rounded shadow-sm text-center">
                                    <div class="fs-3 fw-bolder">{{@$investor->industry?$investor->industry->name:'---'}}</div>
                                    <!--begin::Label-->
                                    <div class="fw-bold  text-gray-400">Industry</div>
                                    <!--end::Label-->
                                    </div>
                                    <!--end::Stat-->
                                </div>
                            ...
                            <div class="mb-8">
                                ...
                                <!--end::Heading-->
                                <div class="fw-bold">
                                    {{$investor->country?$investor->country->country_name:'---'}}
                                </div>
                            </div>
                            ...
                            <div class="mb-8">
                                ...
                                <a href="#" class="flex-grow-1 fw-bold ms-2">{{$investor->web_link}}</a>
                                </div>
                        ...
                        <div class="col-md-8 pe-xxl-15 order-md-first">
                            <div class="mb-10">
                                ...
                                <!--end::Separator-->
                                <p class="fw-bold fs-5 mt-4 text-gray-600 text-dark">{{ @$investor->about }}</p>
                            </div>
                            <div class="mb-10">
                            <!--begin::Title-->
                            ...
                            <div class="mb-16 mt-md-0 mt-17">
                                ...
                                <div class="d-flex flex-stack flex-wrap">
                                    ...
                                    <div class="fs-5 fw-bolder">
                                        <a href="javascript:void(0)"
                                        class="text-gray-700 text-hover-primary">{{@$investor->company_name}}</a>
